...
function App() {
  const initialState = {
    data: [
      ...
      },
      {
        ...
        image: "../public/Aoashi.jpeg",
        episode: "28",
      },
    ],
  };

  const [heroMovie, setHeroMovie] = useState(initialState.data[0]);
  ...
  return (
    <div className={"app"}>
      ...
      <Explore movie={heroMovie} />
      <br />
      <h2>New Release</h2>
      {/* <NewRelease movies={initialState.data} onSelectMovie={onSelectMovie} /> */}
    </div>
  );
}
